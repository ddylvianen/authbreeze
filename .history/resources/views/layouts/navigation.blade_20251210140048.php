    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (Auth::check() && in_array(Auth::user()->rolname, ['tandarts', 'praktijkmanagement']))
                ...
                @endif
                @if (Auth::check() && in_array(Auth::user()->rolname, ['mondhygienist', 'praktijkmanagement']))
                ...
                @endif
                @if (Auth::check() && in_array(Auth::user()->rolname, ['assistent', 'praktijkmanagement']))
                ...
                @endif
                @if (Auth::check() && in_array(Auth::user()->rolname, [ 'praktijkmanagement']))

                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link :href="route('assistent.index')" :active="request()->routeIs('praktijkmanagement.index')">
                            {{ __('assistent') }}
                        </x-nav-link>
                    </div>
                @endif
