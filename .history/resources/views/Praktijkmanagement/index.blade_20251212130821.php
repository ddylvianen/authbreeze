<x-app-layout>
    ...
    <table class="min-w-full divide-y divide-gray-200 rounded-lg overflow-hidden">
        <thead class="bg-gray-100">
            <tr>
                <th class="px-4 py-3 text-xs font-semibold text-gray-600 uppercase text-left">Product</th>
                <th class="px-4 py-3 text-xs font-semibold text-gray-600 uppercase text-left">Price</th>
                <th class="px-4 py-3 text-xs font-semibold text-gray-600 uppercase text-left">Stock</th>
